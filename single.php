...
<header class="p-header">
  ...
  <main class="l-main">
    <article class="p-main-visual__single">
      <h1>h1 チーズバーガー</h1>
    </article>

    <article class="p-main-contents__single">
      <h2>見出しh2</h2>
      ...
      <h4>見出しh5</h4>
      <h4>見出しh6</h4>
      <aside class="p-main-contents__single__text-area">
      ...
      <img class="p-main-contents__single-menu-image" src="images/single_main-contents_img01.svg">

      <div class="p-main-contents__menu-wrapper">
        <img src="images/single_main-contents_img01.svg">
      ...
      <img class="p-main-contents__menu-list__top" src="images/single_main-contents_img01.svg">
      <ul class="p-main-contents__menu-list">
        <li><img src="images/single_main-contents_img01.svg"></li>
        <li><img src="images/single_main-contents_img01.svg"></li>
        <li><img src="images/single_main-contents_img01.svg"></li>
        <li><img src="images/single_main-contents_img01.svg"></li>
        <li><img src="images/single_main-contents_img01.svg"></li>
      ...
      <aside class="p-main-contents__single__text-box">
        <p>&lt;html&gt;</p>
        <p>&lt;head&gt;</p>
        <p>&lt;/head&gt;</p>
        <p>&lt;body&gt;</p>
      ...
      <table class="p-main-contents__single__table">
        <tr>
          <td>テーブル</td>
          <td>テーブル</td>
        </tr>
      ...
      <button class="c-single-page__button">ボタン</button>
